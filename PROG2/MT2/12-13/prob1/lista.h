 ...
 *  observacao: se a lista n�o foi criada retorna NULL
 */
lista* lista_nova();
 ...
 *  parametro: origem origem da pesquisa: a partir do in�cio (INICIO) ou a partir do fim (FIM)
 ...
 *  retorno: -1 se ocorrer um erro, 0 se lst1 for igual a lst2 e 1 caso contr�rio
 */
